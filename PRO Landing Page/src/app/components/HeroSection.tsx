      ...
      <div className="relative z-10 w-full max-w-[1400px] mx-auto px-6 md:px-16 pt-28 pb-20 flex flex-col lg:flex-row items-center gap-12">
        ...
        <div className="flex-1 flex flex-col gap-5 text-white max-w-[620px]">
          <h1 className="font-['Poppins',sans-serif] font-semibold text-[32px] md:text-[46px] leading-[1.1] tracking-[-1.5px]">
            Corporate PRO Services, Fully Managed.
          </h1>
          <p className="font-['Poppins',sans-serif] text-[17px] md:text-[20px] leading-[1.4] tracking-[-0.2px] text-white/90">
            No missed deadlines. No internal follow ups. No operational disruption.
          </p>
          <p className="font-['Poppins',sans-serif] leading-[1.65] text-white/80 text-[15px]">
            TASC takes ownership of your corporate records, renewals, workforce documentation, and regulatory tracking so your leadership team stays focused on performance and growth.
          </p>
        </div>
